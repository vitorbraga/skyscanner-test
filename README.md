...
***NB:** For an API key and instructions for submitting your solution, please read the Code Challenge information provided on your Challenge Invitation page on Geektastic.com (the link that you received in the Challenge Invitation email).
